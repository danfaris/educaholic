...
var Demo = (function () {
    var a,
      ...
      r,
      l,
      n = document.querySelector('#demoForm'),
    ...
    !(function () {
      for (var a = window.location.search.substring(1).split('&'), e = 0; e < a.length; e++) {
        ...
        ('colorScheme' != o && 'navPosition' != o && 'sidebarColor' != o) ||
          (localStorage.setItem('dashkit' + o.charAt(0).toUpperCase() + o.slice(1), r), (b[o] = r));
      }
    })(),
      'light' == (a = b.colorScheme)
        ? ((p.disabled = !1), (h.disabled = !0))
        : 'dark' == a && ((p.disabled = !0), (h.disabled = !1)),
      (function (a) {
        if (s && i && c && d)
          if ('topnav' == a) {
            t(i), t(c);
      ...
      c &&
        ('default' == e
          ...
          : 'vibrant' == e && (c.classList.remove('navbar-light'), c.classList.add('navbar-dark', 'bg-vibrant'))),
      (t = n),
      (o = b.colorScheme),
      (r = b.navPosition),
      (l = b.sidebarColor),
            ...
            (e.options.scales.yAxes[0].ticks.callback = function (a) {
              ...
              (e.options.tooltips.callbacks.label = function (a, e) {
                var t = e.datasets[a.datasetIndex].label || '',
                  ...
                  r = '';
                return (
                  1 < e.datasets.length && (r += '<span class="popover-body-label mr-auto">' + t + '</span>'),
              ...
              global: {
                ...
                tooltips: {
                  ...
                  custom: function (r) {
                    ...
                    if (
                      (a.length ||
                        ((a = $('<div id="chart-tooltip" class="popover bs-popover-top" role="tooltip"></div>')),
                        $('body').append(a)),
                      0 !== r.opacity)
                    ) {
                      if (r.body) {
      ...
      (e = new Chart(a, {
        ...
        options: {
          scales: {
            yAxes: [
              {
                gridLines: { color: ThemeCharts.colors.gray[900], zeroLineColor: ThemeCharts.colors.gray[900] },
                ticks: {
                  callback: function (a) {
                    if (!(a % 10)) return '$' + a + 'k';
                  },
          ...
          datasets: [
            {
              ...
              hoverBorderColor:
                'dark' == ThemeCharts.colorScheme ? ThemeCharts.colors.gray[800] : ThemeCharts.colors.white,
            },
          ],
        },
      })),
