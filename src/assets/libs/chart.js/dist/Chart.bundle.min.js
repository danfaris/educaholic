        ...
        function (t, e, n) {
            ...
            return [
              100 *
                (0.4124 * (e = 0.04045 < e ? Math.pow((e + 0.055) / 1.055, 2.4) : e / 12.92) +
                  0.3576 * (n = 0.04045 < n ? Math.pow((n + 0.055) / 1.055, 2.4) : n / 12.92) +
                  0.1805 * (i = 0.04045 < i ? Math.pow((i + 0.055) / 1.055, 2.4) : i / 12.92)),
          ...
          function d(t) {
            ...
            return (
              (i /= 100),
              (a /= 108.883),
              (n = 0.008856 < (n /= 95.047) ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116),
              [
                116 * (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116) - 16,
                500 * (n - i),
                200 * (i - (a = 0.008856 < a ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116)),
              ]
            );
          }
          function h(t) {
          ...
          function v(t) {
            ...
            return (
              ...
              [
                ...
                500 * (e - n),
                200 * (n - (i = 0.008856 < i ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116)),
              ]
            );
          }
          function y(t) {
            ...
            return (
              (a =
                r <= 8
                  ...
                  : ((n = 100 * Math.pow((r + 16) / 116, 3)), Math.pow(n / 100, 1 / 3))),
              [
                (e =
                  e / 95.047 <= 0.008856
          ...
          e.exports = {
            ...
            hsl2hsv: function (t) {
              var e = t[0],
                ...
                i = t[2] / 100;
              return 0 !== i
                ? [e, 100 * ((2 * (n *= (i *= 2) <= 1 ? i : 2 - i)) / (i + n)), 100 * ((i + n) / 2)]
                : [0, 0, 0];
            },
            hsl2hwb: function (t) {
              return o(h(t));
            ...
            (n = function () {
              ...
              function b(t) {
                if (null == t._isValid) {
                  ...
                  if (
                    (t._strict &&
                      (i = i && 0 === e.charsLeftOver && 0 === e.unusedTokens.length && void 0 === e.bigHour),
                    ...
                    (V[e] =
                      ...
                      (function (i) {
                        ...
                        for (t = 0, a = r.length; t < a; t++)
                          H[r[t]]
                            ? (r[t] = H[r[t]])
                            : (r[t] = (e = r[t]).match(/\[[\s\S]/) ? e.replace(/^\[|\]$/g, '') : e.replace(/\\/g, ''));
                        return function (t) {
                          var e,
                            n = '';
              ...
              function Tt(t, e, n) {
                t.isValid() &&
                  !isNaN(n) &&
                  ('FullYear' === e && Mt(t.year()) && 1 === t.month() && 29 === t.date()
                    ? t._d['set' + (t._isUTC ? 'UTC' : '') + e](n, t.month(), Ot(n, t.month()))
              ...
              function Rt(t, e) {
                ...
                return (
                  (n = Math.min(t.date(), Ot(t.year(), e))), t._d['set' + (t._isUTC ? 'UTC' : '') + 'Month'](e, n), t
                );
              }
              function Lt(t) {
              ...
              function Ht(t, e, n, i, a) {
                ...
                return (
                  (o = s <= 0 ? wt((r = t - 1)) + s : s > wt(t) ? ((r = t + 1), s - wt(t)) : ((r = t), s)),
                  { year: r, dayOfYear: o }
                );
              }
              function Bt(t, e, n) {
                  ...
                  n &&
                    ...
                    ((e =
                      n[mt] < 0 || 11 < n[mt]
                        ...
                        ? pt
                        : n[vt] < 0 || 24 < n[vt] || (24 === n[vt] && (0 !== n[bt] || 0 !== n[yt] || 0 !== n[xt]))
                        ? vt
                        : n[bt] < 0 || 59 < n[bt]
                        ? bt
                        : n[yt] < 0 || 59 < n[yt]
                      ...
                      t._w &&
                        ...
                        (function (t) {
                          ...
                          i < 1 || i > Et(n, r, o)
                            ...
                            : ((s = Ht(n, i, a, r, o)), (t._a[gt] = s.year), (t._dayOfYear = s.dayOfYear));
                        })(t),
                      null != t._dayOfYear &&
                        ((r = he(t._a[gt], i[gt])),
                ...
                if (t._f !== c.ISO_8601)
                  if (t._f !== c.RFC_2822) {
                    ...
                    var e,
                      ...
                      d = u.length,
                      h = 0;
                    for (i = j(t._f, t._locale).match(N) || [], e = 0; e < i.length; e++)
                      (a = i[e]),
                        (n = (u.match(ut(a, t)) || [])[0]) &&
                          (0 < (r = u.substr(0, u.indexOf(n))).length && v(t).unusedInput.push(r),
                    ...
                    (v(t).charsLeftOver = d - h),
                      ...
                      (t._a[vt] = (function (t, e, n) {
                        ...
                        return null != t.meridiemHour
                          ? t.meridiemHour(e, n)
                          : (null != t.isPM && ((i = t.isPM(n)) && e < 12 && (e += 12), i || 12 !== e || (e = 0)), e);
                              ...
                              null === (a = be.exec(i._i))
                                ? (ye(i),
                                  !1 === i._isValid &&
                                    (delete i._isValid,
                                    we(i),
                                    !1 === i._isValid && (delete i._isValid, c.createFromInputFallback(i))))
                                : (i._d = new Date(+a[1])))
                            : s(n)
              ...
              function De(t, e, n, i, a) {
                ...
                return (
                  ...
                  (o._f = e),
                  (o._strict = i),
                  (r = new _(de(Se(o))))._nextDay && (r.add(1, 'd'), (r._nextDay = void 0)),
                  r
                );
              }
              function Ce(t, e, n, i) {
              ...
              function Ae(t) {
                ...
                (this._isValid = (function (t) {
                  for (var e in t) if (-1 === St.call(Ie, e) || (null != t[e] && isNaN(t[e]))) return !1;
                    ...
                    : 'object' == typeof r &&
                      ...
                      ((a = (function (t, e) {
                        ...
                        (e = Ne(e, t)),
                          t.isBefore(e)
                            ? (n = Ue(t, e))
                            : (((n = Ue(e, t)).milliseconds = -n.milliseconds), (n.months = -n.months));
                        return n;
                      })(Ce(r.from), Ce(r.to))),
                      ((r = {}).ms = a.milliseconds),
                      (r.M = a.months)),
              ...
              (un.add = Ze),
                ...
                (un.from = function (t, e) {
                  return this.isValid() && ((k(t) && t.isValid()) || Ce(t).isValid())
                    ? Ee({ to: this, from: t }).locale(this.locale()).humanize(!e)
                ...
                (un.to = function (t, e) {
                  return this.isValid() && ((k(t) && t.isValid()) || Ce(t).isValid())
                    ? Ee({ from: this, to: t }).locale(this.locale()).humanize(!e)
                    : this.localeData().invalidDate();
                }),
                (un.toNow = function (t) {
                  return this.to(Ce(), t);
                ...
                (un.toISOString = function (t) {
                  ...
                  return n.year() < 0 || 9999 < n.year()
                    ? E(n, e ? 'YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYYYY-MM-DD[T]HH:mm:ss.SSSZ')
                    : P(Date.prototype.toISOString)
                    ? e
                      ? this.toDate().toISOString()
                      : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace('Z', E(n, 'Z'))
                    : E(n, e ? 'YYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYY-MM-DD[T]HH:mm:ss.SSSZ');
                }),
                (un.inspect = function () {
                ...
                (un.local = function (t) {
                  return (
                    this._isUTC && (this.utcOffset(0, t), (this._isUTC = !1), t && this.subtract(ze(this), 'm')), this
                  );
                }),
              ...
              (hn.calendar = function (t, e, n) {
                ...
                (hn.months = function (t, e) {
                  return t
                    ? s(this._months)
                      ...
                      : this._months[(this._months.isFormat || It).test(e) ? 'format' : 'standalone'][t.month()]
                    : s(this._months)
                    ? this._months
                ...
                (hn.monthsShort = function (t, e) {
                  return t
                    ? s(this._monthsShort)
                      ...
                      : this._monthsShort[It.test(e) ? 'format' : 'standalone'][t.month()]
                    : s(this._monthsShort)
                    ? this._monthsShort
                ...
                (hn.monthsRegex = function (t) {
                  return this._monthsParseExact
                    ? (g(this, '_monthsRegex') || Nt.call(this), t ? this._monthsStrictRegex : this._monthsRegex)
                ...
                (hn.monthsShortRegex = function (t) {
                  return this._monthsParseExact
                    ...
                    : (g(this, '_monthsShortRegex') || (this._monthsShortRegex = Yt),
                ...
                (hn.weekdaysRegex = function (t) {
                  return this._weekdaysParseExact
                    ? (g(this, '_weekdaysRegex') || Jt.call(this), t ? this._weekdaysStrictRegex : this._weekdaysRegex)
                ...
                (hn.weekdaysShortRegex = function (t) {
                  return this._weekdaysParseExact
                    ...
                    : (g(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = Zt),
                ...
                (hn.weekdaysMinRegex = function (t) {
                  return this._weekdaysParseExact
                    ...
                    : (g(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = Xt),
                ...
                se('en', {
                  ...
                  ordinal: function (t) {
                    var e = t % 10;
                    return (
                      t + (1 === M((t % 100) / 10) ? 'th' : 1 === e ? 'st' : 2 === e ? 'nd' : 3 === e ? 'rd' : 'th')
                    );
                  },
                }),
              ...
              return (
                ...
                (Bn.as = function (t) {
                  ...
                  if ('month' === (t = F(t)) || 'year' === t)
                    return (e = this._days + i / 864e5), (n = this._months + bn(e)), 'month' === t ? n : n / 12;
                ...
                (c.updateLocale = function (t, e) {
                  if (null != e) {
                    ...
                    null != ie[t] &&
                      (null != ie[t].parentLocale ? (ie[t] = ie[t].parentLocale) : null != ie[t] && delete ie[t]);
                  return ie[t];
                }),
                (c.locales = function () {
                  return i(ie);
                  ...
                  title: function (t, e) {
                    ...
                    return (
                      0 < t.length &&
                        (t[0].yLabel
                          ? (n = t[0].yLabel)
                          : 0 < e.labels.length && t[0].index < e.labels.length && (n = e.labels[t[0].index])),
                      n
                    );
                  },
                  label: function (t, e) {
            ...
            (e.exports = function (e) {
              (e.controllers.bar = e.DatasetController.extend({
                  ...
                  (t._xScale = i.getScaleForId(r.xAxisID)),
                    ...
                    (t._model = {
                      ...
                      backgroundColor: s.backgroundColor
                        ? s.backgroundColor
                        : S.valueAtIndexOrDefault(o.backgroundColor, e, l.backgroundColor),
                      borderColor: s.borderColor
                        ? s.borderColor
                        : S.valueAtIndexOrDefault(o.borderColor, e, l.borderColor),
                      borderWidth: s.borderWidth
                        ? s.borderWidth
                        : S.valueAtIndexOrDefault(o.borderWidth, e, l.borderWidth),
                    }),
                  ...
                  for (e = 0; e < r; ++e)
                    (n = i.getDatasetMeta(e)).bar &&
                      ...
                      (!1 === a ||
                        ...
                        (void 0 === a && (void 0 === n.stack || -1 === o.indexOf(n.stack)))) &&
                      o.push(n.stack);
                  return o;
                },
                    ...
                    min: S.isNullOrUndef(n.options.barThickness)
                      ? (function (t, e) {
                          ...
                          for (a = 0, r = s.length; a < r; ++a)
                            (i = t.getPixelForTick(a)), (o = 0 < a ? Math.min(o, i - n) : o), (n = i);
                          return o;
                        })(n, l)
                      : -1,
                    pixels: l,
                  ...
                  if (f || (void 0 === f && void 0 !== g))
                    for (n = 0; n < t; ++n)
                      (i = l.getDatasetMeta(n)).bar &&
                        ...
                        ((a = d.getRightValue(h[n].data[e])), ((c < 0 && a < 0) || (0 <= c && 0 < a)) && (m += a));
                  return (
                    (r = d.getPixelForValue(m)),
                    { size: (s = ((o = d.getPixelForValue(m + c)) - r) / 2), base: r, head: o, center: o + s / 2 }
                  );
                },
                calculateBarIndexPixels: function (t, e, n) {
                    ...
                    _ =
                      'flex' === x.barThickness
                        ? ((h = e),
                          ...
                          null === b && (b = p + p - v),
                          (g = p - ((p - v) / 2) * y),
                          { chunk: (((b - v) / 2) * y) / c.stackCount, ratio: f.barPercentage, start: g })
                        : ((i = e),
                          (a = n),
                          (l = (r = x).barThickness),
                          (u = a.stackCount),
                          (d = a.pixels[i]),
                          (s = S.isNullOrUndef(l)
                            ? ((o = a.min * r.categoryPercentage), r.barPercentage)
                            : ((o = l * u), 1)),
                  ...
                  return { base: w - M / 2, head: w + M / 2, center: w, size: M };
                },
                draw: function () {
                  var t = this.chart,
              ...
              t.controllers.bubble = t.DatasetController.extend({
                ...
                _resolveElementOptions: function (t, e) {
                  var n,
                    ...
                    d = o.data[e],
                    h = {},
                    c = { chart: r, dataIndex: e, dataset: o, datasetIndex: this.index },
                    f = [
                      'backgroundColor',
                      'borderColor',
                      'borderWidth',
              ...
              t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                update: function (n) {
                  ...
                  if (c < 2 * Math.PI) {
                    var f = a.rotation % (2 * Math.PI),
                      ...
                      x = (f <= 0.5 * Math.PI && 0.5 * Math.PI <= g) || (f <= 2.5 * Math.PI && 2.5 * Math.PI <= g),
                      _ = (f <= -Math.PI && -Math.PI <= g) || (f <= Math.PI && Math.PI <= g),
                      k = (f <= 0.5 * -Math.PI && 0.5 * -Math.PI <= g) || (f <= 1.5 * Math.PI && 1.5 * Math.PI <= g),
                      w = h / 100,
                      ...
                      P = 0.5 * (D - M),
                      T = 0.5 * (C - S);
                    (l = Math.min(o / P, s / T)), (u = { x: -0.5 * (D + M), y: -0.5 * (C + S) });
                  }
                  ...
                  var i = this,
                    ...
                    f =
                      n && s.animateRotate
                        ...
                        : t.hidden
                        ? 0
                        : i.calculateCircumference(c.data[e]) * (o.circumference / (2 * Math.PI)),
                ...
                getMaxBorderWidth: function (t) {
                  for (var e, n, i = 0, a = this.index, r = t.length, o = 0; o < r; o++)
                    i =
                      (i = i < (e = t[o]._model ? t[o]._model.borderWidth : 0) ? e : i) <
            ...
            (e.exports = function (t) {
              ...
              t.controllers.line = t.DatasetController.extend({
                ...
                update: function (t) {
                    ...
                    c &&
                      ...
                      (o._model = {
                        ...
                        cubicInterpolationMode: i.cubicInterpolationMode
                          ...
                          : g.valueOrDefault(h.cubicInterpolationMode, u.cubicInterpolationMode),
                      }),
                      o.pivot()),
                      e = 0,
                      n = s.length;
                  ...
                  for (c && 0 !== o._model.tension && a.updateBezierControlPoints(), e = 0, n = s.length; e < n; ++e)
                    s[e].pivot();
                },
                getPointBackgroundColor: function (t, e) {
                  ...
                  return (
                    a.backgroundColor
                      ...
                      ? (n = g.valueAtIndexOrDefault(i.pointBackgroundColor, e, n))
                ...
                getPointBorderWidth: function (t, e) {
                  ...
                  return (
                    isNaN(a.borderWidth)
                      ? !isNaN(i.pointBorderWidth) || g.isArray(i.pointBorderWidth)
                        ? (n = g.valueAtIndexOrDefault(i.pointBorderWidth, e, n))
                ...
                getPointRotation: function (t, e) {
                  ...
                  return (
                    isNaN(a.rotation)
                      ? (isNaN(i.pointRotation) && !g.isArray(i.pointRotation)) ||
                ...
                draw: function () {
                  ...
                  for (
                    ...
                    g.canvas.clipArea(e.ctx, { left: a.left, right: a.right, top: a.top - t, bottom: a.bottom + t }),
                    n.dataset.draw(),
                ...
                setHoverStyle: function (t) {
                  ...
                  (t.$previousStyle = {
                    ...
                    (a.backgroundColor =
                      ...
                      g.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, g.getHoverColor(a.backgroundColor))),
                    (a.borderColor =
                      i.hoverBorderColor ||
                      g.valueAtIndexOrDefault(e.pointHoverBorderColor, n, g.getHoverColor(a.borderColor))),
                    (a.borderWidth =
                      i.hoverBorderWidth || g.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth)),
                    (a.radius =
                      i.hoverRadius ||
                      g.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius));
                },
              });
            });
        },
              ...
              t.controllers.polarArea = t.DatasetController.extend({
                ...
                update: function (n) {
                  var t,
                    ...
                    l = (a._starts = []),
                    u = (a._angles = []);
                  for (a._updateRadius(), o.count = a.countVisibleElements(), t = 0, e = r.data.length; t < e; t++)
                  ...
                  void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius),
                    ...
                    u.extend(t, {
                      ...
                      _model: {
                        ...
                        tension: a.tension
                          ? a.tension
                          : u.valueOrDefault(r.lineTension, i.chart.options.elements.line.tension),
                        radius: a.radius ? a.radius : u.valueAtIndexOrDefault(r.pointRadius, e, s.radius),
                        backgroundColor: a.backgroundColor
                          ? a.backgroundColor
                          : u.valueAtIndexOrDefault(r.pointBackgroundColor, e, s.backgroundColor),
                        borderColor: a.borderColor
                          ? a.borderColor
                          : u.valueAtIndexOrDefault(r.pointBorderColor, e, s.borderColor),
                        borderWidth: a.borderWidth
                          ? a.borderWidth
                          : u.valueAtIndexOrDefault(r.pointBorderWidth, e, s.borderWidth),
                        pointStyle: a.pointStyle
                          ? a.pointStyle
                          : u.valueAtIndexOrDefault(r.pointStyle, e, s.pointStyle),
                        rotation: a.rotation ? a.rotation : u.valueAtIndexOrDefault(r.pointRotation, e, s.rotation),
                        hitRadius: a.hitRadius
                          ? a.hitRadius
                          : u.valueAtIndexOrDefault(r.pointHitRadius, e, s.hitRadius),
                      },
                    }),
                ...
                setHoverStyle: function (t) {
                  ...
                  (t.$previousStyle = {
                    ...
                    (a.radius = n.hoverRadius
                      ? n.hoverRadius
                      : u.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                    (a.backgroundColor = n.hoverBackgroundColor
                      ? n.hoverBackgroundColor
                      : u.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, u.getHoverColor(a.backgroundColor))),
                    (a.borderColor = n.hoverBorderColor
                      ? n.hoverBorderColor
                      : u.valueAtIndexOrDefault(e.pointHoverBorderColor, i, u.getHoverColor(a.borderColor))),
                    (a.borderWidth = n.hoverBorderWidth
                      ? n.hoverBorderWidth
                      : u.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth));
                },
              });
            });
        },
                ...
                for (var e, n, i = this.animations, a = 0; a < i.length; )
                  (n = (e = i[a]).chart),
                    ...
                    e.currentStep >= e.numSteps
                      ? (r.callback(e.onAnimationComplete, [e], n), (n.animating = !1), i.splice(a, 1))
                      : ++a;
              },
            });
        },
              ...
              c.extend(u.prototype, {
                ...
                buildOrUpdateScales: function () {
                  ...
                  t.scales &&
                    ...
                    t.scale &&
                      e.push({ options: t.scale, dtype: 'radialLinear', isDefault: !0, dposition: 'chartArea' }),
                    c.each(e, function (t) {
                      var e = t.options,
                        n = e.id,
                      ...
                      if (n in s && s[n].type === i) ((a = s[n]).options = e), (a.ctx = o.ctx), (a.chart = o);
                        ...
                        if (!r) return;
                        (a = new r({ id: n, type: i, options: e, ctx: o.ctx, chart: o })), (s[a.id] = a);
                      }
                  ...
                  return (
                    c.each(
                      ...
                      function (t, e) {
                        ...
                        if (
                          (n.type && n.type !== i && (r.destroyDatasetMeta(e), (n = r.getDatasetMeta(e))),
                          (n.type = i),
                          o.push(n.type),
                          n.controller)
                        )
                ...
                updateDataset: function (t) {
                  ...
                  !1 !== g.notify(this, 'beforeDatasetUpdate', [n]) &&
                    (e.controller.update(), g.notify(this, 'afterDatasetUpdate', [n]));
                },
                render: function (t) {
                  var e = this;
                  (t && 'object' == typeof t) || (t = { duration: t, lazy: arguments[1] });
                ...
                drawDataset: function (t, e) {
                  ...
                  !1 !== g.notify(this, 'beforeDatasetDraw', [i]) &&
                    (n.controller.draw(e), g.notify(this, 'afterDatasetDraw', [i]));
                },
                ...
                destroy: function () {
                  ...
                  i &&
                    (n.unbindEvents(), c.canvas.clear(n), f.releaseContext(n.ctx), (n.canvas = null), (n.ctx = null)),
                    g.notify(n, 'destroy'),
                ...
                initToolTip: function () {
                  var t = this;
                  t.tooltip = new i({ _chart: t, _chartInstance: t, _data: t.data, _options: t.options.tooltips }, t);
                },
                bindEvents: function () {
                  var e = this,
                    n = (e._listeners = {}),
                  ...
                  ? (a || (a = e._view = {}),
                    ...
                    (function (t, e, n, i) {
                      ...
                      for (a = 0, r = f.length; a < r; ++a)
                        if (
                          ((u = n[(o = f[a])]), e.hasOwnProperty(o) || (e[o] = u), (s = e[o]) !== u && '_' !== o[0])
                        ) {
            ...
            update: function (e, n, t) {
              if (e) {
                ...
                N.each(u.concat(h), W),
                  ...
                  N.each(d, W),
                  N.each(c, W),
                  (e.chartArea = { left: D, top: P, right: D + y, bottom: P + x }),
                  N.each(f, function (t) {
              ...
              function Y(e) {
                ...
                if (t)
                  if (e.isHorizontal()) {
                    var n = { left: Math.max(D, k), right: Math.max(C, w), top: 0, bottom: 0 };
              ...
              function W(t) {
                t.isHorizontal()
                  ? ((t.left = t.fullWidth ? r : D),
                    ...
                    (t.bottom = L + t.height),
                    (L = t.bottom))
                  : ((t.left = R), (t.right = R + t.width), (t.top = P), (t.bottom = P + x), (R = t.right));
              }
            },
          };
        },
      ...
      33: [
        function (t, e, n) {
          ...
          function w(t) {
            ...
            return { size: i, style: a, family: r, font: B.fontString(i, a, r) };
          }
          function M(t) {
              ...
              update: function (t, e, n) {
                ...
                for (
                  u.beforeUpdate(),
                    u.maxWidth = t,
                    u.maxHeight = e,
                    u.margins = B.extend({ left: 0, right: 0, top: 0, bottom: 0 }, n),
              ...
              fit: function () {
                ...
                if (a.display && s) {
                  ...
                  if (l) {
                    ...
                    0 !== t.labelRotation
                      ? ((t.paddingLeft = 'bottom' === i.position ? v * y + 3 : v * g + 3),
                        (t.paddingRight = 'bottom' === i.position ? v * g + 3 : v * x + 3))
                      : ((t.paddingLeft = y / 2 + 3), (t.paddingRight = x / 2 + 3));
                  } else
                    a.mirror ? (c = 0) : (c += m + g),
              ...
              _autoSkip: function (t) {
                ...
                for (
                  s.maxTicksLimit && (a = s.maxTicksLimit),
                    o &&
                      ((e = !1),
                      (h + s.autoSkipPadding) * l > r.width - (r.paddingLeft + r.paddingRight) &&
                        (e =
                          1 + Math.floor(((h + s.autoSkipPadding) * l) / (r.width - (r.paddingLeft + r.paddingRight)))),
              ...
              draw: function (S) {
                ...
                if (C.display) {
                    ...
                    (B.each(F, function (t, e) {
                      if (!B.isNullOrUndef(t.label)) {
                        var n,
                          ...
                          p = t.label;
                        r =
                          e === D.zeroLineIndex && C.offset === O.offsetGridLines
                            ? ((n = O.zeroLineWidth),
                              (i = O.zeroLineColor),
                        ...
                        if (A) {
                          ...
                          m =
                            'bottom' === C.position
                              ? ((b = I ? 'middle' : 'top'), (v = I ? 'right' : 'center'), D.top + x)
                              : ((b = I ? 'middle' : 'bottom'), (v = I ? 'left' : 'center'), D.bottom - x);
                          ...
                          var k,
                            w = 'left' === C.position;
                          (k = T.mirror ? ((v = w ? 'left' : 'right'), y) : ((v = w ? 'right' : 'left'), R + y)),
                    ...
                    B.each(Y, function (t) {
                      if (
                        (O.display &&
                          ...
                          o.beginPath(),
                          O.drawTicks && (o.moveTo(t.tx1, t.ty1), o.lineTo(t.tx2, t.ty2)),
                          O.drawOnChartArea && (o.moveTo(t.x1, t.y1), o.lineTo(t.x2, t.y2)),
                          o.stroke(),
                          o.restore()),
                        T.display)
                      ) {
                        ...
                        if (B.isArray(e))
                          for (
                            var n = e.length, i = 1.5 * l.size, a = D.isHorizontal() ? 0 : (-i * (n - 1)) / 2, r = 0;
                            r < n;
                            ++r
                          )
                  ...
                  if (O.drawBorder) {
                    ...
                    A
                      ? ((v = b = 'top' === C.position ? D.bottom : D.top), (v += y), (b += y))
                      : ((m = p = 'left' === C.position ? D.right : D.left), (m += y), (p += y)),
                      o.beginPath(),
                      o.moveTo(m, v),
                      o.lineTo(p, b),
                      o.stroke();
          ...
          (e.exports = a.extend({
                ...
                k.filter &&
                  ...
                  (C = (function (t, e) {
                    ...
                    (T = (function (t, e) {
                      ...
                      return (
                        (n.font = R.fontString(u, e._titleFontStyle, e._titleFontFamily)),
                        R.each(e.title, f),
                  ...
                  'right' === c
                    ? (s -= a.width)
                    : 'center' === c &&
                      ((s -= a.width / 2) + a.width > o.width && (s = o.width - a.width), s < 0 && (s = 0)),
            ...
            getCaretPosition: function (t, e, n) {
              ...
              if ('center' === c)
                ...
                ((r =
                  ((i =
                    'left' === h ? (a = f + d + u) - u : 'right' === h ? (a = f + m - d - u) - u : (a = n.caretX) - u),
                  a + u)),
                'top' === c)
              )
                (s = (o = g) - u), (l = o);
                ...
                for (
                  ...
                  (e = s[t]),
                    ...
                    0 === t
                      ...
                      : ((n = -1 === u ? n : s[u]),
                        i.skip ||
                          ((u !== t - 1 && !o) || -1 === u ? r.moveTo(i.x, i.y) : d.canvas.lineTo(r, n._view, e._view),
                          (u = t)));
                r.stroke(), r.restore();
              },
            }));
            ...
            (e.exports = a.extend({
              ...
              getCenterPoint: function () {
                var t,
                  ...
                  n = this._view;
                return (
                  (e = l(this) ? ((t = n.x), (n.y + n.base) / 2) : ((t = (n.x + n.base) / 2), n.y)), { x: t, y: e }
                );
              },
              getArea: function () {
                var t = this._view;
          ...
          var i,
            d = {
              ...
              each: function (t, e, n, i) {
                var a, r, o;
                if (d.isArray(t))
                  if (((r = t.length), i)) for (a = r - 1; 0 <= a; a--) e.call(n, t[a], a);
            ...
            a = {
              ...
              easeInElastic: function (t) {
                ...
                return 0 === t
                  ...
                  ? 1
                  : (n || (n = 0.3),
                    (e = i < 1 ? ((i = 1), n / 4) : (n / (2 * Math.PI)) * Math.asin(1 / i)),
            ...
            addEventListener: function (r, t, o) {
              ...
              if ('resize' !== t) {
                ...
                y(
                  e,
                  t,
                  ((n.proxies || (n.proxies = {}))[r.id + '_' + t] = function (t) {
                    var e, n, i, a;
                    o(
                      ((n = r),
                      (i = s[(e = t).type] || e.type),
        ...
        function (t, e, n) {
          ...
          function m(t) {
            ...
            if (
              ...
              if ('number' == typeof r && isFinite(r)) return { x: (e = i.isHorizontal()) ? r : null, y: e ? null : r };
            }
            return null;
          }
          function p(t, e, n) {
              ...
              for (i = 0; i < u; ++i)
                (r = null),
                  (a = (n = t.getDatasetMeta(i)).dataset) &&
                    a._model &&
                    a instanceof c.Line &&
                    (r = { visible: t.isDatasetVisible(i), fill: g(a, i, u), chart: t, el: a }),
                  (n.$filler = r),
                  h.push(r);
              for (i = 0; i < u; ++i)
                (r = h[i]) &&
                  ...
                  (r.mapper =
                    ((l = void 0),
                    (s = (o = r).fill),
                    !(l = 'dataset') === s ? null : (isFinite(s) || (l = 'boundary'), f[l](o)))));
            },
                ...
                if (((r.font = d), f)) {
                  ...
                  (r.textAlign = 'left'),
                    ...
                    C.each(i.legendItems, function (t, e) {
                      ...
                      g[g.length - 1] + n + a.padding >= i.width && ((m += s + a.padding), (g[g.length] = i.left)),
                  ...
                  C.each(i.legendItems, function (t, e) {
                    var n = P(a, s) + s / 2 + r.measureText(t.text).width;
                    x + _ > c.height && ((b += y + a.padding), v.push(y), (x = y = 0)),
                      (y = Math.max(y, n)),
                      (x += _),
                      (h[e] = { left: 0, top: 0, width: n, height: s });
                  }),
            ...
            draw: function () {
              ...
              if (c.display) {
                ...
                var k = P(f, _),
                  ...
                  M = h.isHorizontal();
                b = M
                  ? { x: h.left + (p - v[0]) / 2, y: h.top + f.padding, line: 0 }
                ...
                C.each(h.legendItems, function (t, e) {
                  var n,
                    ...
                    d = b.y;
                  M
                    ? p <= u + l && ((d = b.y += S), b.line++, (u = b.x = h.left + (p - v[b.line]) / 2))
                    : d + S > h.bottom &&
                      ((u = b.x = u + h.columnWidths[b.line] + f.padding), (d = b.y = h.top + f.padding), b.line++),
                    (function (t, e, n) {
                      if (!(isNaN(k) || k <= 0)) {
                        y.save(),
                        ...
                        if (
                          (y.setLineDash && y.setLineDash(x(n.lineDash, m.borderDash)),
                    ...
                    n.hidden && (y.beginPath(), (y.lineWidth = 2), y.moveTo(r, o), y.lineTo(r + i, o), y.stroke()),
          ...
          e.exports = {
            ...
            beforeUpdate: function (t) {
              var e = t.options.legend,
                n = t.legend;
              e
                ? (C.mergeIf(e, D.global.legend), n ? (a.configure(t, n, e), (n.options = e)) : s(t, e))
          ...
          var o = i.extend({
            ...
            draw: function () {
              ...
              if (n.display) {
                ...
                var b = n.text;
                if (k.isArray(b)) for (var y = 0, x = 0; x < b.length; ++x) t.fillText(b[x], 0, y, a), (y += h);
          ...
          e.exports = {
            ...
            beforeUpdate: function (t) {
              var e = t.options.title,
                n = t.titleBlock;
              e
                ? (k.mergeIf(e, _.global.title), n ? (a.configure(t, n, e), (n.options = e)) : s(t, e))
          ...
          e.exports = function () {
            var t = i.extend({
              ...
              buildTicks: function () {
                ...
                this.ticks =
                  0 === this.minIndex && this.maxIndex === t.length - 1 ? t : t.slice(this.minIndex, this.maxIndex + 1);
              },
              ...
              getValueForPixel: function (t) {
                ...
                return (
                  (t -= i ? this.left : this.top), e && (t -= a / 2), (t <= 0 ? 0 : Math.round(t / a)) + this.minIndex
                );
              },
              getBasePixel: function () {
                return this.bottom;
                    ...
                    h.each(t, function (t, e) {
                      ...
                      l.isDatasetVisible(e) &&
                        ...
                        h.each(t.data, function (t, e) {
                          ...
                          isNaN(n) ||
                            i.data[e].hidden ||
                            (null === o.min ? (o.min = n) : n < o.min && (o.min = n),
                  ...
                  a = (t.ticks = (function (t, e) {
                    ...
                    if (t.stepSize && 0 < t.stepSize) a = t.stepSize;
                      ...
                      (a = h.niceNum(o / (t.maxTicks - 1), !0)),
                        void 0 !== (i = t.precision) && ((n = Math.pow(10, i)), (a = Math.ceil(a * n) / n));
                    }
                    ...
                    h.isNullOrUndef(t.min) ||
                      ...
                      !t.stepSize ||
                      (h.almostWhole((t.max - t.min) / t.stepSize, a / 1e3) && ((s = t.min), (l = t.max)));
                    var u = (l - s) / a;
      ...
      57: [
        function (t, e, n) {
          ...
          e.exports = function (h) {
            var t = { position: 'left', ticks: { callback: r.formatters.logarithmic } },
              e = i.extend({
                determineDataLimits: function () {
                  var o = this,
                    n = o.options,
                ...
                handleTickRangeOptions: function () {
                  ...
                  (t.min = n(e.min, t.min)),
                    ...
                    t.min === t.max &&
                      (0 !== t.min && null !== t.min
                        ? ((t.min = Math.pow(10, Math.floor(c.log10(t.min)) - 1)),
                          (t.max = Math.pow(10, Math.floor(c.log10(t.max)) + 1)))
                        : ((t.min = 1), (t.max = 10))),
                    ...
                    null === t.minNotZero &&
                      (0 < t.min
                        ? (t.minNotZero = t.min)
                        : t.max < 1
                        ? (t.minNotZero = Math.pow(10, Math.floor(c.log10(t.max))))
                        : (t.minNotZero = 1));
                },
                buildTicks: function () {
                  var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                      ...
                      0 === o
                        ? ((n = Math.floor(c.log10(e.minNotZero))),
                          ...
                          a.push(o),
                          (o = i * Math.pow(10, n)))
                        : ((n = Math.floor(c.log10(o))), (i = Math.floor(o / Math.pow(10, n))));
                      for (
                ...
                getPixelForValue: function (t) {
                  ...
                  return (
                    (t = +o.getRightValue(t)),
                    (r = s ? ((i = o.end), (a = o.start), -1) : ((i = o.start), (a = o.end), 1)),
                    (n = o.isHorizontal()
                      ? ((e = o.width), s ? o.right : o.left)
                      : ((e = o.height), (r *= -1), s ? o.top : o.bottom)),
                    t !== i &&
                      (0 === i &&
                        ((e -= d = c.getValueOrDefault(o.options.ticks.fontSize, h.defaults.global.defaultFontSize)),
                        (i = u)),
        ...
        function (t, e, n) {
          ...
          e.exports = function (t) {
            ...
            function y(t) {
              ...
              return { size: n, style: i, family: a, font: _.fontString(n, i, a) };
            }
            ...
            var n = t.LinearScaleBase.extend({
                  ...
                  ? (function (t) {
                      ...
                      for (e = 0; e < h; e++) {
                        (i = t.getPointPosition(e, r)),
                          ...
                          (d = t.pointLabels[e] || ''),
                          (n = _.isArray(d)
                            ? { w: _.longestText(l, l.font, d), h: d.length * u + 1.5 * (d.length - 1) * u }
              ...
              getPointPosition: function (t, e) {
                ...
                return { x: Math.round(Math.cos(n) * e) + this.xCenter, y: Math.round(Math.sin(n) * e) + this.yCenter };
              },
                      ...
                      if (
                        (o.display &&
                          ...
                          (function (t, e, n, i) {
                            var a = t.ctx;
                            if (
                              ((a.strokeStyle = _.valueAtIndexOrDefault(e.color, i - 1)),
                              (a.lineWidth = _.valueAtIndexOrDefault(e.lineWidth, i - 1)),
                              t.options.gridLines.circular)
                            )
                              a.beginPath(), a.arc(t.xCenter, t.yCenter, n, 0, 2 * Math.PI), a.closePath(), a.stroke();
                            else {
                              var r = b(t);
                              if (0 === r) return;
                              a.beginPath();
                        ...
                        if (
                          ((u.font = c), u.save(), u.translate(r.xCenter, r.yCenter), u.rotate(d), s.showLabelBackdrop)
                        ) {
                    ...
                    (t.angleLines.display || t.pointLabels.display) &&
                      (function (t) {
                        ...
                        var r,
                          ...
                          s,
                          l,
                          u = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max),
                          d = y(t);
                        e.textBaseline = 'top';
        ...
        function (t, e, n) {
          ...
          function M(t, e) {
            ...
            return 'function' == typeof n
              ...
              ? y(t, i)
              : (t instanceof y || (t = y(t)), t.isValid() ? t : 'function' == typeof i ? i(t) : t);
          }
          function S(t, e) {
          ...
          function D(t) {
            for (var e = _.indexOf(t) + 1, n = _.length; e < n; ++e) if (x[_[e]].common) return _[e];
          }
          function C(t, e, n, i) {
            var a,
              r = i.time,
              o =
                ...
                (function (t, e, n, i) {
                  ...
                  for (a = _.indexOf(t); a < s - 1; ++a)
                    if (
                      ((o = (r = x[_[a]]).steps ? r.steps[r.steps.length - 1] : v),
            ...
            for (
              l ||
                ...
                a = y(c),
                d && s && !u && !r.round && (a.startOf(s), a.add(~~((c - a) / (h.size * l)) * l, o));
              a < f;
              a.add(l, o)
            )
              g.push(+a);
          ...
          e.exports = function () {
            var t = i.extend({
              ...
              determineDataLimits: function () {
                ...
                g.length && ((g = k(g).sort(b)), (d = Math.min(d, g[0])), (h = Math.max(h, g[g.length - 1]))),
                  c.length && ((c = k(c).sort(b)), (d = Math.min(d, c[0])), (h = Math.max(h, c[c.length - 1]))),
                  (d = S(l.min, o) || d),
                  (h = S(l.max, o) || h),
                  (d = d === v ? +y().startOf(u) : d),
                  (h = h === m ? +y().endOf(u) + 1 : h),
              ...
              buildTicks: function () {
                ...
                for (
                  'ticks' === m.bounds && v.length && ((f = v[0]), (g = v[v.length - 1])),
                    f = S(p.min, c) || f,
                    g = S(p.max, c) || g,
                    t = 0,
                    e = v.length;
                ...
                return (
                  ...
                  (function (t, e) {
                    var n,
                      ...
                      o = [];
                    for (n = 0, i = t.length; n < i; ++n)
                      (a = t[n]), (r = !!e && a === +y(a).startOf(e)), o.push({ value: a, major: r });
                    return o;
                  })(b, c._majorUnit)
                );
              },
