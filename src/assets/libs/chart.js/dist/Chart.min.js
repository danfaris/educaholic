                  ...
                  title: function (t, e) {
                    ...
                    return (
                      0 < t.length &&
                        (t[0].yLabel
                          ? (i = t[0].yLabel)
                          : 0 < e.labels.length && t[0].index < e.labels.length && (i = e.labels[t[0].index])),
                      i
                    );
                  },
                  label: function (t, e) {
                  ...
                  var n = this,
                    ...
                    f =
                      i && s.animateRotate
                        ...
                        : t.hidden
                        ? 0
                        : n.calculateCircumference(h.data[e]) * (r.circumference / (2 * Math.PI)),
                    ...
                    h &&
                      ...
                      (r._model = {
                        ...
                        cubicInterpolationMode: n.cubicInterpolationMode
                          ...
                          : g.valueOrDefault(c.cubicInterpolationMode, u.cubicInterpolationMode),
                      }),
                      r.pivot()),
                      e = 0,
                      i = s.length;
                ...
                setHoverStyle: function (t) {
                  ...
                  (t.$previousStyle = {
                    ...
                    (a.backgroundColor =
                      ...
                      g.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, g.getHoverColor(a.backgroundColor))),
                    (a.borderColor =
                      n.hoverBorderColor ||
                      g.valueAtIndexOrDefault(e.pointHoverBorderColor, i, g.getHoverColor(a.borderColor))),
                    (a.borderWidth =
                      n.hoverBorderWidth || g.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth)),
                    (a.radius =
                      n.hoverRadius ||
                      g.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius));
                },
              });
            });
        },
                  ...
                  void 0 !== o.radius && void 0 === o.pointRadius && (o.pointRadius = o.radius),
                    ...
                    u.extend(t, {
                      ...
                      _model: {
                        ...
                        tension: a.tension
                          ? a.tension
                          : u.valueOrDefault(o.lineTension, n.chart.options.elements.line.tension),
                        radius: a.radius ? a.radius : u.valueAtIndexOrDefault(o.pointRadius, e, s.radius),
                        backgroundColor: a.backgroundColor
                          ? a.backgroundColor
                          : u.valueAtIndexOrDefault(o.pointBackgroundColor, e, s.backgroundColor),
                        borderColor: a.borderColor
                          ? a.borderColor
                ...
                setHoverStyle: function (t) {
                  ...
                  (t.$previousStyle = {
                    ...
                    (a.radius = i.hoverRadius
                      ? i.hoverRadius
                      : u.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius)),
                    (a.backgroundColor = i.hoverBackgroundColor
                      ? i.hoverBackgroundColor
                      : u.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, u.getHoverColor(a.backgroundColor))),
                    (a.borderColor = i.hoverBorderColor
                      ? i.hoverBorderColor
                      : u.valueAtIndexOrDefault(e.pointHoverBorderColor, n, u.getHoverColor(a.borderColor))),
            ...
            (u.types = {}),
              ...
              h.extend(u.prototype, {
                  ...
                  return (
                    h.each(
                      ...
                      function (t, e) {
                        ...
                        if (
                          (i.type && i.type !== n && (o.destroyDatasetMeta(e), (i = o.getDatasetMeta(e))),
                          (i.type = n),
                          r.push(i.type),
                          i.controller)
                        )
                ...
                destroy: function () {
                  ...
                  n &&
                    (i.unbindEvents(), h.canvas.clear(i), f.releaseContext(i.ctx), (i.canvas = null), (i.ctx = null)),
                    g.notify(i, 'destroy'),
                  ...
                  ? (a || (a = e._view = {}),
                    ...
                    (function (t, e, i, n) {
                      ...
                      for (a = 0, o = f.length; a < o; ++a)
                        if (
                          ((u = i[(r = f[a])]), e.hasOwnProperty(r) || (e[r] = u), (s = e[r]) !== u && '_' !== r[0])
                        ) {
                  ...
                  s.maxTicksLimit && (a = s.maxTicksLimit),
                    r &&
                      ...
                      (c + s.autoSkipPadding) * l > o.width - (o.paddingLeft + o.paddingRight) &&
                        (e =
                          1 + Math.floor(((c + s.autoSkipPadding) * l) / (o.width - (o.paddingLeft + o.paddingRight)))),
                  ...
                  if (
                        ...
                        if (F) {
                          ...
                          p =
                            'bottom' === D.position
                              ...
                              : ((b = T ? 'middle' : 'bottom'), (v = T ? 'left' : 'center'), _.bottom - y);
                          ...
                          var M,
                            w = 'left' === D.position;
                          (M = I.mirror ? ((v = w ? 'left' : 'right'), x) : ((v = w ? 'right' : 'left'), R + x)),
                    ...
                    H.each(z, function (t) {
                      if (
                        ...
                        if (H.isArray(e))
                          for (
                            var i = e.length, n = 1.5 * l.size, a = _.isHorizontal() ? 0 : (-n * (i - 1)) / 2, o = 0;
                            o < i;
                            ++o
                          )
          ...
          (e.exports = a.extend({
              ...
              if (S.length) {
                ...
                M.filter &&
                  ...
                  'right' === h
                    ? (s -= a.width)
                    : 'center' === h &&
                      ((s -= a.width / 2) + a.width > r.width && (s = r.width - a.width), s < 0 && (s = 0)),
            ...
            getCaretPosition: function (t, e, i) {
              ...
              if ('center' === h)
                ...
                ((o =
                  ((n =
                    'left' === c ? (a = f + d + u) - u : 'right' === c ? (a = f + p - d - u) - u : (a = i.caretX) - u),
                  a + u)),
                'top' === h)
              )
                (s = (r = g) - u), (l = r);
                ...
                for (
                  ...
                  (e = s[t]),
                    ...
                    0 === t
                      ...
                      : ((i = -1 === u ? i : s[u]),
                        n.skip ||
                          ((u !== t - 1 && !r) || -1 === u ? o.moveTo(n.x, n.y) : d.canvas.lineTo(o, i._view, e._view),
                          (u = t)));
                o.stroke(), o.restore();
              },
            }));
            ...
            (e.exports = a.extend({
              ...
              getCenterPoint: function () {
                var t,
                  ...
                  i = this._view;
                return (
                  (e = l(this) ? ((t = i.x), (i.y + i.base) / 2) : ((t = (i.x + i.base) / 2), i.y)), { x: t, y: e }
                );
              },
              getArea: function () {
                var t = this._view;
                ...
                if (((o.font = d), f)) {
                  ...
                  (o.textAlign = 'left'),
                    ...
                    D.each(n.legendItems, function (t, e) {
                      ...
                      g[g.length - 1] + i + a.padding >= n.width && ((p += s + a.padding), (g[g.length] = n.left)),
              ...
              if (h.display) {
                ...
                D.each(c.legendItems, function (t, e) {
                  var i,
                    ...
                    d = b.y;
                  C
                    ? m <= u + l && ((d = b.y += S), b.line++, (u = b.x = c.left + (m - v[b.line]) / 2))
                    : d + S > c.bottom &&
                      ((u = b.x = u + c.columnWidths[b.line] + f.padding), (d = b.y = c.top + f.padding), b.line++),
                    (function (t, e, i) {
                      if (!(isNaN(M) || M <= 0)) {
                        x.save(),
        ...
        function (t, e, i) {
          ...
          var r = n.extend({
            ...
            fit: function () {
              ...
              t.isHorizontal() ? ((o.width = t.maxWidth), (o.height = l)) : ((o.width = l), (o.height = t.maxHeight)),
                (t.width = o.width),
                (t.height = o.height);
            },
            afterFit: o,
                  ...
                  a = (t.ticks = (function (t, e) {
                    ...
                    if (t.stepSize && 0 < t.stepSize) a = t.stepSize;
                      ...
                      (a = c.niceNum(r / (t.maxTicks - 1), !0)),
                        void 0 !== (n = t.precision) && ((i = Math.pow(10, n)), (a = Math.ceil(a * i) / i));
                    }
                    ...
                    c.isNullOrUndef(t.min) ||
                      ...
                      !t.stepSize ||
                      (c.almostWhole((t.max - t.min) / t.stepSize, a / 1e3) && ((s = t.min), (l = t.max)));
                    var u = (l - s) / a;
              ...
              e = n.extend({
                ...
                getPixelForValue: function (t) {
                  ...
                  return (
                    ...
                    t !== n &&
                      (0 === n &&
                        ((e -= d = h.getValueOrDefault(r.options.ticks.fontSize, c.defaults.global.defaultFontSize)),
                        (n = u)),
                  ...
                  ? (function (t) {
                      ...
                      for (e = 0; e < c; e++) {
                        (n = t.getPointPosition(e, o)),
                          ...
                          (d = t.pointLabels[e] || ''),
                          (i = k.isArray(d)
                            ? { w: k.longestText(l, l.font, d), h: d.length * u + 1.5 * (d.length - 1) * u }
                  ...
                  k.each(o.ticks, function (t, e) {
                    if (0 < e || s.reverse) {
                      ...
                      if (
                        ...
                        if (
                          ((u.font = h), u.save(), u.translate(o.xCenter, o.yCenter), u.rotate(d), s.showLabelBackdrop)
                        ) {
                ...
                return (
                  ...
                  (function (t, e) {
                    var i,
                      ...
                      r = [];
                    for (i = 0, n = t.length; i < n; ++i)
                      (a = t[i]), (o = !!e && a === +x(a).startOf(e)), r.push({ value: a, major: o });
                    return r;
                  })(b, h._majorUnit)
                );
              },
