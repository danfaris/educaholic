  ...
  var g = { exports: {} },
    ...
    j = (function (a) {
      function g(a, c) {
        ...
        if (
          (null == e.options.url &&
            (e.options.url = e.element.getAttribute('action')),
          !e.options.url)
        )
        ...
        return (
          e.options.acceptedMimeTypes &&
            ((e.options.acceptedFiles = e.options.acceptedMimeTypes),
            delete e.options.acceptedMimeTypes),
          ...
          e.options.clickable &&
            (!0 === e.options.clickable
              ...
              : (e.clickableElements = g.getElements(
                  e.options.clickable,
                  'clickable'
                ))),
          e.init(),
                ...
                (this.prototype.defaultOptions = {
                    ...
                    return (
                      h &&
                        (null != h.textContent
                          ...
                          : null != h.innerText &&
                            (h.innerText = this.options.dictFallbackMessage)),
                  ...
                  addedfile: function (a) {
                    ...
                    if (
                      ...
                      (a.previewElement = g.createElement(
                      ...
                      for (
                        var i = a.previewElement.querySelectorAll(
                            '[data-dz-size]'
                          ),
                          j = Array.isArray(i),
                          k = 0,
                      ...
                      for (
                        var l = function (c) {
                          ...
                          m = a.previewElement.querySelectorAll(
                            '[data-dz-remove]'
                          ),
                          n = Array.isArray(m),
                          o = 0,
          ...
          [
                    ...
                    if (d.length > 0) {
                      for (
                        ...
                        i.isFile
                          ...
                          : i.isDirectory &&
                            c._addFilesFromDirectory(i, b + '/' + i.name);
                      }
                      a();
                    }
                    return null;
            ...
            },
            {
              ...
              value: function (a, b, c, d, e) {
                ...
                return this.createThumbnail(a, b, c, d, !0, function (b, c) {
                  ...
                  return (
                    ('image/jpeg' !== d && 'image/jpg' !== d) ||
                      (h = o.restore(a.dataURL, h)),
                    e(g.dataURItoBlob(h))
                  );
                });
              },
            ...
            },
            {
              ...
              value: function (a, b) {
                ...
                a[0].upload.chunked &&
                  (a[0].upload.chunks[b[0].chunkIndex].xhr = d);
                ...
                if (this.options.params) {
                  ...
                  'function' == typeof p &&
                    (p = p.call(
                      ...
                      a,
                      d,
                      a[0].upload.chunked ? this._getChunk(a[0], d) : null
                    ));
                  for (var q in p) {
                    var r = p[q];
                    o.append(q, r);
                ...
                this.options.uploadMultiple &&
                  this.emit('sendingmultiple', a, d, o),
              ...
              value: function (a) {
                if ('FORM' === this.element.tagName)
                  for (
                    ...
                    if (
                      (h && (h = h.toLowerCase()), void 0 !== g && null !== g)
                    )
              ...
              value: function (a, b, c) {
                if (a[0].status !== g.CANCELED) {
                  if (a[0].upload.chunked && this.options.retryChunks) {
                    ...
                    if (d.retries++ < this.options.retryChunksLimit)
                      return void this._uploadData(a, [d.dataBlock]);
  ...
  (j.createElement = function (a) {
    ...
    (j.getElements = function (a, b) {
      ...
      if (a instanceof Array) {
        ...
        d = [];
        for (
          var h = document.querySelectorAll(a),
            i = Array.isArray(h),
            j = 0,
            h = i ? h : h[Symbol.iterator]();
          ;
      ...
      for (
        ...
        if (((i = i.trim()), '.' === i.charAt(0))) {
          if (
            ...
            a.name
              .toLowerCase()
              .indexOf(i.toLowerCase(), a.name.length - i.length)
          )
            return !0;
        } else if (/\/\*$/.test(i)) {
