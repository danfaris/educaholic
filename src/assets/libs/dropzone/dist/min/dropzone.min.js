...
var _createClass = (function () {
  ...
  Dropzone = (function (a) {
    function b(a, c) {
      ...
      if ((null == d.options.url && (d.options.url = d.element.getAttribute('action')), !d.options.url))
      ...
      return (
        d.options.acceptedMimeTypes &&
          ((d.options.acceptedFiles = d.options.acceptedMimeTypes), delete d.options.acceptedMimeTypes),
        ...
        !1 !== d.options.previewsContainer &&
          (d.options.previewsContainer
            ? (d.previewsContainer = b.getElement(d.options.previewsContainer, 'previewsContainer'))
            : (d.previewsContainer = d.element)),
        d.options.clickable &&
          (!0 === d.options.clickable
            ? (d.clickableElements = [d.element])
            : (d.clickableElements = b.getElements(d.options.clickable, 'clickable'))),
        d.init(),
        d
      );
    }
            ...
            (this.prototype.Emitter = Emitter),
              ...
              (this.prototype.defaultOptions = {
                ...
                fallback: function () {
                  ...
                  a ||
                    ((a = b.createElement('<div class="dz-message"><span></span></div>')), this.element.appendChild(a));
                  var g = a.getElementsByTagName('span')[0];
                  return (
                    g &&
                      (null != g.textContent
                        ? (g.textContent = this.options.dictFallbackMessage)
                        : null != g.innerText && (g.innerText = this.options.dictFallbackMessage)),
        ...
        [
                    ...
                    events: {
                      click: function (d) {
                        return (
                          (c !== a.element ||
                            d.target === a.element ||
                            b.elementInside(d.target, a.element.querySelector('.dz-message'))) &&
            ...
            value: function (a, c) {
              return this.options.maxFilesize && a.size > 1024 * this.options.maxFilesize * 1024
                ...
                ? null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles
                  ? (c(this.options.dictMaxFilesExceeded.replace('{{maxFiles}}', this.options.maxFiles)),
                ...
                this.accept(a, function (b) {
                  return (
                    b
                      ...
                      : ((a.accepted = !0), c.options.autoQueue && c.enqueueFile(a)),
          ...
          },
          {
            ...
            value: function (a, c, d, e, f) {
              ...
              return this.createThumbnail(a, c, d, e, !0, function (c, d) {
                ...
                return (
                  ('image/jpeg' !== e && 'image/jpg' !== e) || (h = ExifRestore.restore(a.dataURL, h)),
                  f(b.dataURItoBlob(h))
                );
              });
            },
              ...
              this._transformFiles(a, function (d) {
                if (a[0].upload.chunked) {
                  ...
                  for (var j = [], k = 0; k < a.length; k++)
                    j[k] = { name: c._getParamName(k), data: d[k], filename: a[k].upload.filename };
                  c._uploadData(a, j);
                }
              });
            },
          ...
          },
          {
            ...
            value: function (a, c) {
              ...
              if (this.options.params) {
                ...
                'function' == typeof o &&
                  (o = o.call(this, a, e, a[0].upload.chunked ? this._getChunk(a[0], e) : null));
                for (var p in o) {
                  var q = o[p];
                  n.append(p, q);
                }
              ...
              if (a[0].status !== b.CANCELED && 4 === c.readyState) {
                if (
                  ...
                  c.getResponseHeader('content-type') &&
                    ~c.getResponseHeader('content-type').indexOf('application/json'))
                )
                  try {
                    e = JSON.parse(e);
                  } catch (a) {
            ...
            value: function (a, c, d) {
              ...
              if (
                (this.options.uploadMultiple &&
                  (this.emit('successmultiple', a, c, d), this.emit('completemultiple', a)),
          ...
          },
          {
            ...
            value: function (a, c, d) {
              ...
              if (
                (this.options.uploadMultiple && (this.emit('errormultiple', a, c, d), this.emit('completemultiple', a)),
                this.options.autoProcessQueue)
              )
                return this.processQueue();
            },
