  ...
  function M(n, f) {
          ...
          window.requestAnimationFrame(function () {
            if (
              (void 0 !== g.calendarContainer &&
                ((g.calendarContainer.style.visibility = 'hidden'), (g.calendarContainer.style.display = 'block')),
              ...
              (g.daysContainer.style.width = t + 'px'),
                (g.calendarContainer.style.width =
                  t + (void 0 !== g.weekWrapper ? g.weekWrapper.offsetWidth : 0) + 'px'),
      ...
      0 === g.selectedDates.length && ne(),
        void 0 !== e &&
          ...
          (function (e) {
            ...
            void 0 !== g.amPM &&
              e.target === g.amPM &&
              (g.amPM.textContent = g.l10n.amPM[o(g.amPM.textContent === g.l10n.amPM[0])]);
            ...
            if (void 0 !== n.value && 2 === n.value.length) {
              var u = n === g.hourElement,
                f = n === g.minuteElement;
              s < a
                ? ((s = r + s + o(!u) + (o(u) && o(!g.amPM))), f && Y(void 0, -1, g.hourElement))
                : s > r && ((s = n === g.hourElement ? s - r - o(!g.amPM) : a), f && Y(void 0, 1, g.hourElement)),
                g.amPM &&
                  u &&
    ...
    function j(e, t, n, a) {
      ...
      return (
        ...
        -1 === e.indexOf('hidden') &&
          0 === w(t, g.now) &&
          ((g.todayDateElem = o), o.classList.add('today'), o.setAttribute('aria-current', 'date')),
        i
          ? ((o.tabIndex = -1),
            ge(t) &&
              ...
              'range' === g.config.mode &&
                (c(o, 'startRange', g.selectedDates[0] && 0 === w(t, g.selectedDates[0], !0)),
                c(o, 'endRange', g.selectedDates[1] && 0 === w(t, g.selectedDates[1], !0)),
    ...
    function W(e, t) {
      ...
      return void 0 === a
        ...
        ? void (function (e, t) {
            for (
              var n = -1 === e.className.indexOf('Month') ? e.dateObj.getMonth() : g.currentMonth,
              ...
              for (
                var r = g.daysContainer.children[o],
                  l = n - g.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0,
                  c = r.children.length,
                  d = l;
                d >= 0 && d < c && d != (t > 0 ? c : -1);
                d += i
                ...
                var s = r.children[d];
                if (-1 === s.className.indexOf('hidden') && Z(s.dateObj) && Math.abs(e.$i - d) >= Math.abs(t))
                  return H(s);
              }
    ...
    function K() {
      ...
      i.setAttribute('aria-label', g.l10n.yearAriaLabel),
        ...
        g.config.maxDate &&
          ...
          (i.disabled = !!g.config.minDate && g.config.minDate.getFullYear() === g.config.maxDate.getFullYear()));
      ...
      if (g.isOpen && !g.config.inline) {
        var t = 'function' == typeof (r = e).composedPath ? r.composedPath()[0] : r.target,
          ...
          a =
            ...
            (e.path && e.path.indexOf && (~e.path.indexOf(g.input) || ~e.path.indexOf(g.altInput))),
        ...
        (g.currentYear = t || g.currentYear),
          g.config.maxDate && g.currentYear === g.config.maxDate.getFullYear()
            ...
            : g.config.minDate &&
              ...
              (g.currentMonth = Math.max(g.config.minDate.getMonth(), g.currentMonth)),
    ...
    function Z(e, t) {
      ...
      if (
        (g.config.minDate && n && w(n, g.config.minDate, void 0 !== t ? t : !g.minDateHasTime) < 0) ||
        (g.config.maxDate && n && w(n, g.config.maxDate, void 0 !== t ? t : !g.maxDateHasTime) > 0)
      )
        return !1;
      if (0 === g.config.enable.length && 0 === g.config.disable.length) return !0;
      if (void 0 === n) return !1;
      for (
        var a = g.config.enable.length > 0, i = a ? g.config.enable : g.config.disable, o = 0, r = void 0;
        o < i.length;
        o++
      ) {
        ...
        switch (e.keyCode) {
          ...
          case 39:
            if (o) g.hourElement && g.hourElement.focus();
              ...
              (e.preventDefault(),
              void 0 !== g.daysContainer && (!1 === n || (document.activeElement && Q(document.activeElement))))
            ) {
    ...
    function ee(e) {
      if (
        ...
        (!e || (e.classList.contains('flatpickr-day') && !e.classList.contains('disabled')))
      ) {
        for (
          ...
          Z(new Date(d), !0) ||
            ((r = r || (d > a && d < i)), d < n && (!l || d > l) ? (l = d) : d > n && (!c || d < c) && (c = d));
                  ...
                  : (['startRange', 'inRange', 'endRange', 'notAllowed'].forEach(function (e) {
                    ...
                    void (
                      ...
                      (!u.contains(e) && s > 0 && f && f.lastChild.dateObj.getTime() >= d) ||
                        ...
                        d >= l && (0 === c || d <= c) && b(d, n, t) && o.classList.add('inRange')))
                    ));
              },
              p = 0,
              h = u.children.length;
      ...
      return function (t) {
        ...
        void 0 !== n &&
          ...
          g.daysContainer &&
            ...
            (g.currentYearElement.disabled = !!a && void 0 !== n && a.getFullYear() === n.getFullYear()));
      };
    }
    function ie() {
      'object' != typeof g.config.locale &&
        void 0 === E.l10ns[g.config.locale] &&
        g.config.errorHandler(new Error('flatpickr: invalid locale ' + g.config.locale)),
        (g.l10n = e(
          {},
          E.l10ns.default,
          'object' == typeof g.config.locale
    ...
    function ce(e) {
      ...
      if (void 0 !== t) {
        var n = t,
          ...
          i =
            (a.getMonth() < g.currentMonth || a.getMonth() > g.currentMonth + g.config.showMonths - 1) &&
            'range' !== g.config.mode;
    ...
    (g.parseDate = D({ config: g.config, l10n: g.l10n })),
      ...
      (g.close = function () {
        (g.isOpen = !1),
          g.isMobile ||
            (void 0 !== g.calendarContainer && g.calendarContainer.classList.remove('open'),
      ...
      (g.destroy = function () {
        ...
        if (((g._handlers = []), g.mobileInput))
          g.mobileInput.parentNode && g.mobileInput.parentNode.removeChild(g.mobileInput), (g.mobileInput = void 0);
      ...
      (g.open = function (e, t) {
        ...
        var n = g.isOpen;
        (g.isOpen = !0),
          n || (g.calendarContainer.classList.add('open'), g._input.classList.add('active'), fe('onOpen'), oe(t));
    ...
    function ve(e) {
      ...
      void 0 !== g.mobileInput &&
        g.mobileFormatStr &&
        (g.mobileInput.value =
          void 0 !== g.latestSelectedDateObj ? g.formatDate(g.latestSelectedDateObj, g.mobileFormatStr) : ''),
        ...
        (g.element = g.input = n),
          ...
          (function () {
            ...
            i.dateFormat ||
              ...
              (o.dateFormat =
                i.noCalendar || r
                  ...
                  : E.defaultConfig.dateFormat + ' H:i' + (i.enableSeconds ? ':S' : '')),
              i.altInput &&
                (i.enableTime || r) &&
                !i.altFormat &&
                (o.altFormat =
                  i.noCalendar || r
                    ...
                    : E.defaultConfig.altFormat + ' h:i' + (i.enableSeconds ? ':S' : '') + ' K'),
            ...
            for (var d = 0; d < g.config.plugins.length; d++) {
              ...
              for (var u in s)
                t.indexOf(u) > -1
                  ? (g.config[u] = l(s[u]).map(h).concat(g.config[u]))
          ...
          g.isMobile ||
            (function () {
                    ...
                    Object.defineProperty(g, '_hidePrevMonthArrow', {
                      ...
                      set: function (e) {
                        g.__hidePrevMonthArrow !== e &&
                          (c(g.prevMonthNav, 'disabled', e), (g.__hidePrevMonthArrow = e));
                      },
                    }),
                    Object.defineProperty(g, '_hideNextMonthArrow', {
                      ...
                      set: function (e) {
                        g.__hideNextMonthArrow !== e &&
                          (c(g.nextMonthNav, 'disabled', e), (g.__hideNextMonthArrow = e));
                      },
                    }),
                  ...
                  (function () {
                    ...
                    if (
                      ...
                      (g.minuteElement.value = i(
                        g.latestSelectedDateObj ? g.latestSelectedDateObj.getMinutes() : g.config.defaultMinute
                      )),
                      ...
                      (g.secondElement = a.getElementsByTagName('input')[0]),
                        (g.secondElement.value = i(
                          g.latestSelectedDateObj ? g.latestSelectedDateObj.getSeconds() : g.config.defaultSeconds
                        )),
                    ...
                    return (
                      g.config.time_24hr ||
                        ((g.amPM = d(
                          'span',
                          'flatpickr-am-pm',
                          g.l10n.amPM[o((g.latestSelectedDateObj ? g.hourElement.value : g.config.defaultHour) > 11)]
                        )),
              ...
              if (
                ...
                g.config.inline &&
                  (!r && g.element.parentNode
                    ? g.element.parentNode.insertBefore(g.calendarContainer, g._input.nextSibling)
                    : void 0 !== g.config.appendTo && g.config.appendTo.appendChild(g.calendarContainer)),
                g.config.static)
              ) {
              ...
              g.config.static ||
                g.config.inline ||
                (void 0 !== g.config.appendTo ? g.config.appendTo : window.document.body).appendChild(
                  g.calendarContainer
                );
            })(),
          (function () {
          ...
          (g.selectedDates.length || g.config.noCalendar) &&
            (g.config.enableTime && k(g.config.noCalendar ? g.latestSelectedDateObj || g.config.minDate : void 0),
            ve(!1)),
          M(),
