...
!(function (e, t) {
    ...
    w.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = i(e)) || ('function' == typeof (n = f.call(t, 'constructor') && t.constructor) && d.call(n) === p))
        );
      },
                  ...
                  if (v) {
                    ...
                    if (((h = [a ? v.firstChild : v.lastChild]), a && m)) {
                      (b =
                        (p =
                          (l =
                            (c = (f = (d = v)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] ===
                            C && l[1]) && l[2]),
                        (d = p && v.childNodes[p]);
                      ...
                      while ((d = (++p && d && d[g]) || (b = p = 0) || h.pop()))
                        if (
                          (u ? d.nodeName.toLowerCase() === y : 1 === d.nodeType) &&
                          ++b &&
                          (m && ((c = (f = d[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [C, b]),
                          d === t)
                        )
                          break;
      ...
      (a = oe.tokenize = function (e, t) {
        ...
        while (u) {
          (n && !(i = F.exec(u))) || (i && (u = u.slice(i[0].length) || u), s.push((o = []))),
            (n = !1),
            (i = z.exec(u)) &&
              ((n = i.shift()), o.push({ value: n, type: i[0].replace($, ' ') }), (u = u.slice(n.length)));
          for (a in r.filter)
            !(i = X[a].exec(u)) ||
              (l[a] && !(i = l[a](i))) ||
              ((n = i.shift()), o.push({ value: n, type: a, matches: i }), (u = u.slice(n.length)));
          if (!n) break;
        }
      ...
      for (
        ...
        if ((n = r.relative[e[s].type])) d = [me(be(d), n)];
          ...
          if ((n = r.filter[e[s].type].apply(null, e[s].matches))[x]) {
            ...
            return Ce(
              s > 1 && be(d),
              s > 1 && ye(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace($, '$1'),
              n,
              s < i && Te(e.slice(s, i)),
              i < o && Te((e = e.slice(i))),
              i < o && ye(e)
  ...
  w.each(
    {
      ...
      contents: function (e) {
        return D(e, 'iframe')
          ? e.contentDocument
          : (D(e, 'template') && (e = e.content || e), w.merge([], e.childNodes));
      },
    },
    function (e, t) {
      w.fn[e] = function (n, r) {
        ...
        return (
          ...
          this.length > 1 && (P[e] || w.uniqueSort(i), O.test(e) && i.reverse()),
          this.pushStack(i)
        );
      };
    }
                    ...
                    : function () {
                        try {
                          ...
                          w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, c.stackTrace),
                            t + 1 >= o && (r !== M && ((u = void 0), (s = [e])), n.rejectWith(u, s));
                        }
                      };
  ...
  'complete' === r.readyState || ('loading' !== r.readyState && !r.documentElement.doScroll)
    ...
    : (r.addEventListener('DOMContentLoaded', z), e.addEventListener('load', z));
      ...
      if (v && (s = v.events)) {
        ...
        while (l--)
          if (((u = Te.exec(t[l]) || []), (p = g = u[1]), (h = (u[2] || '').split('.').sort()), p)) {
            ...
            a &&
              !d.length &&
              ((f.teardown && !1 !== f.teardown.call(e, h, v.handle)) || w.removeEvent(e, p, v.handle), delete s[p]);
        ...
        while ((o = u[n++]) && !t.isPropagationStopped()) {
          ...
          while ((a = o.handlers[r++]) && !t.isImmediatePropagationStopped())
            (t.rnamespace && !t.rnamespace.test(a.namespace)) ||
              ((t.handleObj = a),
              (t.data = a.data),
              void 0 !== (i = ((w.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, s)) &&
                !1 === (t.result = i) &&
  ...
  function Re(e, t, n, r) {
    ...
    if (
      d &&
      ((i = be(t, e[0].ownerDocument, !1, e, r)), (o = i.firstChild), 1 === i.childNodes.length && (i = o), o || r)
    ) {
      ...
      'margin' === n && (s += w.css(e, n + oe[a], !0, i)),
        r
          ? ('content' === n && (s -= w.css(e, 'padding' + oe[a], !0, i)),
            'margin' !== n && (s -= w.css(e, 'border' + oe[a] + 'Width', !0, i)))
          : ((s += w.css(e, 'padding' + oe[a], !0, i)),
            'padding' !== n
              ? (s += w.css(e, 'border' + oe[a] + 'Width', !0, i))
              : (u += w.css(e, 'border' + oe[a] + 'Width', !0, i)));
    return (
      !r && o >= 0 && (s += Math.max(0, Math.ceil(e['offset' + t[0].toUpperCase() + t.slice(1)] - o - s - u - 0.5))), s
    );
  }
  function et(e, t, n) {
    var r = We(e),
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return 'undefined' == typeof e.getAttribute
            ? w.prop(e, t, n)
            : ((1 === o && w.isXMLDoc(e)) ||
                (i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? tt : void 0)),
              void 0 !== n
                ? null === n
    ...
    (w.offset = {
      setOffset: function (e, t, n) {
        ...
        'static' === c && (e.style.position = 'relative'),
          ...
          (o = w.css(e, 'top')),
          (s = w.css(e, 'left')),
          (l = ('absolute' === c || 'fixed' === c) && (o + s).indexOf('auto') > -1)
