...
var List = (function (t) {
    ...
    (t.exports = function (t) {
      ...
      (n.prototype.toggle = function (t, e) {
        return this.list
          ...
          : ('undefined' != typeof e ? (e ? this.add(t) : this.remove(t)) : this.has(t) ? this.remove(t) : this.add(t),
            this);
      }),
  ...
  function (t, e) {
    ...
    t.exports = (function () {
      return function (t, e, s, a) {
        return (
          (a = a || {}),
          (a.test && a.getElementsByClassName) || (!a.test && document.getElementsByClassName)
            ? r(t, e, s)
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e) {
      (e = e || {}),
        (e = i({ location: 0, distance: 100, threshold: 0.4, multiSearch: !0, searchClass: 'fuzzy-search' }, e));
      var r = {
        search: function (n, i) {
          ...
          for (var m = 1; m <= c; m++) {
            ...
            r.number(m, d, v, f, h)
              ...
              : r.dotted(e, m, d, v, f, h, e.size()) &&
                ((s = e.add({ page: '...', dotted: !0 })[0]), n(s.elm).add('disabled'));
          }
        },
        r = {
      ...
      var e,
        ...
        s = {
          ...
          setColumns: function () {
            0 !== t.items.length &&
              void 0 === r &&
              (r = void 0 === t.searchColumns ? s.toArray(t.items[0].values()) : t.searchColumns);
          },
        ...
        a = {
          ...
          values: function (r, i) {
            return !!(
              r.hasOwnProperty(i) && ((e = t.utils.toString(r[i]).toLowerCase()), '' !== n && e.search(n) > -1)
            );
          },
          reset: function () {
      ...
      (this.clearSourceItem = function (e, r) {
        for (var n = 0, i = r.length; n < i; n++) {
          ...
          if (r[n].data) for (var a = 0, o = r[n].data.length; a < o; a++) e.setAttribute('data-' + r[n].data[a], '');
            ...
            r[n].attr && r[n].name
              ? ((s = t.utils.getByClass(e, r[n].name, !0)), s && s.setAttribute(r[n].attr, ''))
              : ((s = t.utils.getByClass(e, r[n], !0)), s && (s.innerHTML = ''));
          s = void 0;
        }
        return e;
      }),
            ...
            s = function (r, n) {
              ...
              a &&
                (a.data
                  ...
                  : a.attr && a.name
                  ? ((s = t.utils.getByClass(e.elm, a.name, !0)), s && s.setAttribute(a.attr, n))
                  : ((s = t.utils.getByClass(e.elm, a, !0)), s && (s.innerHTML = n)),
                (s = void 0));
            };
  ...
  function (t, e) {
    t.exports = function (t, e, r) {
      ...
      var o = i,
        ...
        c = t.indexOf(e, o);
      c != -1 &&
        ((u = Math.min(n(0, c), u)), (c = t.lastIndexOf(e, o + e.length)), c != -1 && (u = Math.min(n(0, c), u)));
      var f = 1 << (e.length - 1);
      c = -1;
      for (var h, d, v, m = e.length + t.length, g = 0; g < e.length; g++) {
        ...
        for (var b = C; b >= p; b--) {
          ...
          if (
            (0 === g
              ? (y[b] = ((y[b + 1] << 1) | 1) & w)
              : (y[b] = (((y[b + 1] << 1) | 1) & w) | (((v[b + 1] | v[b]) << 1) | 1) | v[b + 1]),
            y[b] & f)
          ) {
            var x = n(g, b - 1);
            if (x <= u) {
